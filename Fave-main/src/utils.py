...
class Data_Train():
    ...
    def split_onebyone(self):
        """
        Build training samples via prefix expansion.
        For interaction [A, B, C], produces subsequences [A, B] and [A, B, C]
        for next-item prediction at each step.
        id_seq: maps sample index to prefix sequence
        id_seq_user: maps sample index to user ID
        """
        self.id_seq = {}
        self.id_seq_user = {}
        idx = 0
